...
const typed2 = new Typed('.multiple-text2',
    {
        strings: ['Python','Java Script', 'HTML', 'CSS', 'C#','SQL','C++','React','Angula','Mangodb','AWS'],
        typeSpeed: 100,
        backSpeed: 100,
        backDelay: 1000,
        loop: true
...
function sendEmail() {
    const bodymessage = `full name: ${fullname.value}<br> Email: ${email.value}<br> Phone: ${phone.value}<br> Subject: ${subject} Message: ${message.value}`;
